...
<form <?php echo tag_attributes($formAttributes); ?>>
    <div id="search-keywords" class="field">
        ...
        <?php
            echo $this->formText(
                'search',
                @$_REQUEST['search'],
                array('id' => 'keyword-search', 'class' => 'input')
            );
        ?>
        </div>
    </div>
    ...
    <div class="field">
        ...
        <?php
            echo $this->formText('tags', @$_REQUEST['tags'],
                array('class' => 'input', 'id' => 'tag-search')
            );
        ?>
        </div>
    </div>
    ...
    <div>
        <input type="submit" class="submit button" name="submit_search" id="submit_search_advanced" value="<?php echo __('Search'); ?>" />
    </div>
</form>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $('#content > h1').first().addClass('headline');
    });
</script>
